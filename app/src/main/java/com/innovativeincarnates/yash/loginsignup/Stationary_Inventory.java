...
public class Stationary_Inventory extends Activity{
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        ch1=(CheckBox)findViewById(R.id.stationary1);
        ch2=(CheckBox)findViewById(R.id.stationary2);
        ch3=(CheckBox)findViewById(R.id.stationary3);
        ch4=(CheckBox)findViewById(R.id.stationary4);
        ch5=(CheckBox)findViewById(R.id.stationary5);
        ch6=(CheckBox)findViewById(R.id.stationary6);
        ch7=(CheckBox)findViewById(R.id.stationary7);
        ch8=(CheckBox)findViewById(R.id.stationary8);
        ch9=(CheckBox)findViewById(R.id.stationary9);
        ch10=(CheckBox)findViewById(R.id.stationary10);
