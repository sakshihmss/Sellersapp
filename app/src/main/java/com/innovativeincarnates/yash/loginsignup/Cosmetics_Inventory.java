...
public class Cosmetics_Inventory extends Activity{
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        ch1=(CheckBox)findViewById(R.id.cosmetics1);
        ch2=(CheckBox)findViewById(R.id.cosmetics2);
        ch3=(CheckBox)findViewById(R.id.cosmetics3);
        ch4=(CheckBox)findViewById(R.id.cosmetics4);
        ch5=(CheckBox)findViewById(R.id.cosmetics5);
        ch6=(CheckBox)findViewById(R.id.cosmetics6);
        ch7=(CheckBox)findViewById(R.id.cosmetics7);
        ch8=(CheckBox)findViewById(R.id.cosmetics8);
        ch9=(CheckBox)findViewById(R.id.cosmetics9);
        ch10=(CheckBox)findViewById(R.id.cosmetics10);
